...
<head>
    ...
    <script>
        ...
        function generarTexto() {
            ...
            var texto = "N° cuenta: " + metodo_pago + ". 7484 7845 8745";
...
<?php include(__DIR__ . '/../templates/header2.php'); ?>
    ...
    <form action="../controllers/VentaController.php?action=store" method="post" enctype="multipart/form-data">
        ...
        <label>
            <input type="radio" name="metodo_pago" value="tarjeta" onchange="toggleImage()" checked> Tarjeta
        </label>
    ...
    <a href="../controllers/VentaController.php?action=index2">Volver a la lista</a>
